...
| Comunicação automatizada com o paciente via WhatsApp/e-mail/SMS | Telefone, e-mail, conteúdo | Consentimento intermediado pelo médico |
...
| **Twilio Inc.** | Envio e recebimento de mensagens WhatsApp e SMS | Estados Unidos / Irlanda | **Sim** | DPA assinado [PENDENTE confirmar] |
...
| Mensagens WhatsApp (`whatsapp_conversation.messages_history`) | **15 dias** | Mínimo necessário para continuidade do diálogo |
| Logs de uso da IA (`ai_token_usage_log`) | 90 dias | Auditoria e custo |
| Logs operacionais (`whatsapp_message_log`, `notification_send_log`) | 180 dias | Suporte e investigação |
| Logs de redação de PII (`ai_pii_redaction_log`) | 12 meses | Compliance |
